    ...
    <div className="space-y-8 mt-8">
      ...
      <div className="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl p-6">
        <div className="flex items-center justify-between mb-0">
          <div>
            <h3 className="text-lg font-semibold text-gray-900">Suivi des séances Mésojet Corps</h3>
            <p className="text-sm text-gray-500 mt-0.5">{sessions.length} séance{sessions.length > 1 ? 's' : ''} enregistrée{sessions.length > 1 ? 's' : ''}</p>
          </div>
          <button
            type="button"
